...
export default function Index() {
  ...
  const {data : courses, isLoading , error , refetch} = useTutorLoadCoursesQuery({
    page : currentPage,
    search : searchQuery,
    limit,
             ...
             className="relative overflow-hidden shadow-lg">
              ...
              <CardContent className="p-4">
                ...
                <div className="flex justify-between items-center">
                  <span className={`text-sm font-medium ${course.status === "approved" ? "text-green-500" : "text-yellow-500"}`}>
                    {course.status === 'approved' ? 'Active' : 'Draft'}
                  </span>
