...
import { changeLessonOrModuleStatus, courseDetails, loadCurrentLesson, progressStatus } from '../controllers/enrolledCourse/userLearningOps.js'
...
router.get('/lesson',loadCurrentLesson)
